...
class SSValidationTextField: UITextField {
    ...
    */
    ...
    private func setup() {
        NotificationCenterNotificationCenterNotificationCenter.default.addObserver(self, selector: "textFieldEdited:", name: UITextField.textDidChangeNotificationUITextField.textDidChangeNotification, object: nil)
    }
